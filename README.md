...
As an **AI Engineer** with a dual background in **Physics** and **Data Science**, I specialize in engineering **Autonomous Agents**, **GPU-optimized workflows**, and **Computer Vision** systems. My work centers on translating cutting-edge research into robust, scalable software—building self-correcting reasoning workflows and multi-modal RAG pipelines that handle ambiguity and multi-step reasoning.
