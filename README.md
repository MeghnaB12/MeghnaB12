...
With a dual background in **Physics** and **Data Science**, I specialize in engineering **Autonomous Agents** and **Computer Vision** systems. My work centers on translating cutting-edge research into robust, scalable software—building self-correcting reasoning workflows and multimodal pipelines that can handle ambiguity and multi-step reasoning.

🧠 **Focus Areas:** Generative AI, Agentic Workflows, MLOps, and Computer Vision.  
📫 **Contact:** meghna.biswal01@gmail.com

---

### 🛠️ Tech Stack
* **Generative AI:** LangGraph, LangChain, Llama 3, Gemini 2.5 Flash, Mistral
* **Computer Vision:** Vision Transformers (ViT-Huge), PyTorch, YOLOv8, EfficientNet
* **Infrastructure & Data:** FastAPI, WebSockets, GCP, Docker, Qdrant, ChromaDB
...
| :--- | :--- | :--- |
| **[Physics-Research-Agent](https://github.com/MeghnaB12/physics-research-agent)** | Multi-Modal RAG Agent that ingests dense scientific literature and autonomously solves embedded physics equations. | `Gemini 2.5 Flash`, `SymPy`, `RAG` |
| **[Unified-Broker](https://github.com/MeghnaB12/unified-broker)** | Real-time financial data layer connecting Zerodha and IBKR. Features live WebSocket orchestration and an AI layer for risk/anomaly detection. | `Python`, `WebSockets`, `Streamlit` |
